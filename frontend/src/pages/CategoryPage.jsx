...
// Función para barajar las preguntas de cada categoría y también reducirla al número de 50
const shuffleArray = array => {
    return array.sort(() => Math.random() - 0.5).slice(0, 50);
};
...
export const CategoryPage = () => {
    ...
    }, [category]); // Añade 'category' como dependencia para actualizar las preguntas cuando la categoría cambia
